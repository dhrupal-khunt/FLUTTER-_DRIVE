    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          CarouselSlider(
            items: [
              Image.asset("assets/images/gandhinagar4.jpg",fit: BoxFit.cover,),
              Image.asset("assets/images/gamdhinagar4.jpg",fit: BoxFit.cover,),
              Image.asset("assets/images/gandhiangar3.jpg",fit: BoxFit.cover,),
              Image.asset("assets/images/gandhinagar2.jpg",fit: BoxFit.cover,)
            ],
